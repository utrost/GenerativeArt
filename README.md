...
The framework currently includes **34 generative algorithms**:
...
34. **Playful Strategies**: A switchable trio of Kelp Forest, Orbit Weave, and Signal Weather strategies with strategy-specific controls.
